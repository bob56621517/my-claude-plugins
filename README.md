...
| unified-search | `/plugin install unified-search@my-claude-plugins` | 统一搜索路由——自动选择最佳搜索后端，支持 Context7/Wikidata/博查/原生搜索 |
...
- `bocha-search` — 中文搜索，支持网页搜索和 AI 语义结构化卡片
- `wikidata` — Wikidata 知识图谱，实体搜索、语句验证、SPARQL 查询
- `context7` — 开源库/SDK 官方文档实时查询
- `unified-search` — 统一搜索路由，自动选择最佳搜索后端
